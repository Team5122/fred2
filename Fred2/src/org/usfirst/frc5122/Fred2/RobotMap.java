...
public class RobotMap {
    ...
    public static Encoder driveStrafeEncoder;
    ...
    public static Solenoid toteGrabberToteGripper;
    public static Solenoid lightsBlinkyLight;
    ...
    public static void init() {
        ...
        driveStrafeEncoder = new Encoder(8, 9, false, EncodingType.k4X);
        LiveWindow.addSensor("Drive", "StrafeEncoder", driveStrafeEncoder);
        driveStrafeEncoder.setDistancePerPulse(0.05235987755982989);
        driveStrafeEncoder.setPIDSourceParameter(PIDSourceParameter.kRate);
        ...
        toteGrabberToteGripper = new Solenoid(0, 2);
        LiveWindow.addActuator("ToteGrabber", "ToteGripper", toteGrabberToteGripper);
        
        lightsBlinkyLight = new Solenoid(0, 7);
        LiveWindow.addActuator("Lights", "BlinkyLight", lightsBlinkyLight);
