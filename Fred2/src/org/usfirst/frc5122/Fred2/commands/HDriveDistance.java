...
public class  HDriveDistance extends Command {
	double forward, turn, strafe, avgEncode, org;
	int wheelSize;
    ...
    protected void initialize() {
    	org = Robot.drive.leftEncoder.getDistance();
    	
    }
    // Called repeatedly when this Command is scheduled to run
    protected void execute() {
    	Robot.drive.hDrive(1,0,0);
    }

    // Make this return true when this Command no longer needs to run execute()
    protected boolean isFinished() {
    	return (forward == Robot.drive.leftEncoder.getDistance() - org);
    }
