...
public class Robot extends IterativeRobot {
    ...
    public static ToteGrabber toteGrabber;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        ...
        autoChooser.addDefault("Default Auto", new Auto1());
    ...
    public void teleopPeriodic() {
    	SmartDashboard.putNumber("LGearBox", RobotMap.driveLeftEncoder.getDistance());
    	SmartDashboard.putNumber("RGearBox", RobotMap.driveRightEncoder.getDistance());
        Scheduler.getInstance().run();
    }
